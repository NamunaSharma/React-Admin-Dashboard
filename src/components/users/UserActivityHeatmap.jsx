...
const UserActivityHeatmap = () => {
  return (
         <motion.div
            className="bg-gray-800 bg-opacity-50 backdrop-blur-md shadow-lg rounded-xl p-6 lg:col-2 border border-gray-700"
          ...
          >
            ...
            <div className='h-80' >
                ...
                <BarChart width={500} height={300} data={userActivityData}>
                    ...
                    <Bar dataKey="12-16" stackId="a" fill="#ff7300" />
                    <Bar dataKey="16-20" stackId="a" fill="#ff0000" />
                    <Bar dataKey="20-24" stackId="a" fill="#0000ff" />
                    </BarChart>
                </ResponsiveContainer>
            </div>
